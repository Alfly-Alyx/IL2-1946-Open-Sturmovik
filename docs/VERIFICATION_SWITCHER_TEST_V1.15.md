...
rapport mesure : `WIP/test-installations/switcher-matrix-20260907-081003/`.
...
`WIP/test-plans/switcher-final-readiness-20260907.json` et `.content.json`.
...
python tools/Audit-SwitcherClassAvailability.py --game-root "WIP/test-installations/IL 2 Sturmovik 1946 test" --output WIP/test-plans/switcher-class-availability-20260907-full-sfs.json
```
