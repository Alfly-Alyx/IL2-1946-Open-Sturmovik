...
`WIP/labs/IL 2 Sturmovik 1946 Selector Dump/dump/com/maddox/il2/ai/UserCfg.class`.
...
```powershell
java -jar WIP/sdk/test-tools/cfr-0.152.jar "WIP/labs/IL 2 Sturmovik 1946 Selector Dump/dump/com/maddox/il2/ai/UserCfg.class" --outputdir build/default-pilot-audit --silent true
```
...
`WIP/test-installations/IL 2 Sturmovik 1946 test/Users/all.before-hawk-f05761338b5048a69e186f7330b7912f.ini`.
