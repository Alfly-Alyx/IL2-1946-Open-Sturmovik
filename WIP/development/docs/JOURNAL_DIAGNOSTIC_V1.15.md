...
- Le laboratoire Selector 5.1.2/Dump Mode est range sous
  `WIP\analyses\labs\IL 2 Sturmovik 1946 Selector Dump`. Il ne constitue ni
...
rangee sous `D:\Projets\GITHUB\#res\IL2 1946\0 - ORIGINAL GAMES DO NOT MODIFIED\Il-2 Sturmovik 1946 _4.09m`, n'a pas ete
...
- jeu de test : `WIP\tests\installations\IL 2 Sturmovik 1946 test` ;
- ressources : `WIP\resources\IL2` ;
- reference originale protegee :
  `D:\Projets\GITHUB\#res\IL2 1946\0 - ORIGINAL GAMES DO NOT MODIFIED\Il-2 Sturmovik 1946 _4.09m`.
...
`WIP/tests/backups/sync-cam-20260904-055053Z`.
...
extraite sous `WIP/dependances/sdk/toolchains`. Elle reconstruit un `wrapper.dll` PE32 i386
...
`WIP/tests/backups/backup-before-clean-20260830.delta` puis rehaches apres copie.
...
`WIP/temporaire`, leurs archives sources restant sauvegardees sous `res`.
...
conserves. `WIP/tests/captures` occupe desormais 41 217 659 829 octets, environ
...
`WIP/tests/backups/sync-cam5-20260904`. Aucun jeu n'a ete relance. Voir
...
sources. Sauvegarde :
`WIP/tests/backups/sync-range-markers-20260904-162052`. Manifeste :
