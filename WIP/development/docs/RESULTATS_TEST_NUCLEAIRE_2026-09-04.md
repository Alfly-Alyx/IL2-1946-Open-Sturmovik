...
Session analysee :
`WIP/tests/captures/startup/20260904-051619Z-profile9-warm-windowed1024-startup`.
...
`WIP/tests/backups/sync-cam-20260904-055053Z`. Le deploiement est consigne dans
...
La session
`WIP/tests/captures/startup/20260904-135929Z-profile9-warm-windowed1024-startup`
