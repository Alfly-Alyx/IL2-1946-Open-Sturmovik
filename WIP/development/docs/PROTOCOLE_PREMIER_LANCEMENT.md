...
2. Conserver Process Monitor et ProcDump x86 portables sous
   `WIP/dependances/sdk/test-tools/sysinternals` ; ces outils Microsoft ne sont pas distribues
   avec l'add-on.
...
`C:\Users\Alexis\DATA\Projets\GITHUB\IL2-1946-Open-Sturmovik\WIP\tests\backups\IL 2 Sturmovik 1946 test.backup-before-clean-20260830`.
...
memoire : ils restent sous `WIP/tests/captures`, sont ignores par Git et ne doivent pas
etre publies bruts.

## Parcours Selector/Dump 4.09m

Un second clone independant est prepare sous
`C:\Users\Alexis\DATA\Projets\GITHUB\IL2-1946-Open-Sturmovik\WIP\analyses\labs\IL 2 Sturmovik 1946 Selector Dump`. Il a ete copie le
...
& .\tools\Install-IL2SelectorDumpLab.ps1 `
  -GameRoot 'C:\Users\Alexis\DATA\Projets\GITHUB\IL2-1946-Open-Sturmovik\WIP\analyses\labs\IL 2 Sturmovik 1946 Selector Dump'
```
