...
Le nouveau lanceur de configuration fusionne dans cette branche fait partie des
travaux prevus pour Open Sturmovik 1.20. Les objectifs historiques propres a
`dev-launcher` restent conserves :

- Poursuivre l'amelioration de la stabilite et de la vitesse de chargement.
- Approfondir et simplifier la configuration de `conf.ini`.
- Maintenir les bibliotheques et les executables compatibles avec le moteur x86.
- Ajouter du nouveau contenu apres validation de sa compatibilite.
